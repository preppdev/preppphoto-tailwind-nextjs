  ...
  <div>
    <main className="lg:relative">
        ...
        <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
            ...
            <span className="block  xl:inline">
              The better the source the material the better the results! Let our team work with you
          ...
          <p className="mx-auto mt-3 max-w-md text-lg  sm:text-xl md:mt-5 md:max-w-3xl">
            ...
            Twilight conversion. With Virtual Twilight, the awesome look of Twilight Photography is
            imagined from a regular daytime photo, saving copious amounts of time and expense. Enjoy
            the benefits of Virtual Twilight for only $5 per photo converted.
          </p>
      ...
      <div className="mx-auto max-w-7xl pt-60 pb-3 lg:absolute lg:inset-y-0 lg:right-0 lg:h-full lg:w-1/2">
        {/* SLIDER */}
        {BeforeAfterImgSlider(8, 9)}
      </div>
      <div className="mx-auto max-w-7xl py-5 px-4 sm:px-2 lg:py-24 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <span className="block font-extrabold text-indigo-600 xl:inline">Virtual Twilight </span>{' '}
