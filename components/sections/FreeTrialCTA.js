...
const FreeTrialCTA = () => {
  return (
    <SectionContainer>
      <div className="mx-auto max-w-7xl bg-prepp-blue p-16 lg:bg-transparent lg:px-8">
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative bg-prepp-blue lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            <div
            ...
            <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              ...
              <Link
                href="/freetrial"
                className="block w-full rounded-md border border-transparent bg-prepp-orange py-3 px-5 text-center text-base font-medium text-indigo-700 shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto"
              >
                Try for Free
              </Link>
            </div>
